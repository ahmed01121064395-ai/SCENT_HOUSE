    ...
    <div id="view-shipping-policy" className="active">
      ...
      <div className="section-wrapper" style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
        <div className="text-right space-y-6 leading-relaxed text-gray-700" style={{ fontSize: '0.95rem' }}>
          ...
          <p>
            في حال تعذر الوصول إليك في موعد التوصيل المحدد، سيقوم مندوب التوصيل بإجراء محاولة ثانية للتسليم في اليوم التالي بعد التنسيق الهاتفي. وفي حال فشل المحاولة الثانية أو تعذر التواصل، سيتم إرجاع الطلب إلى مقر الدار، ويُرجى التواصل معنا عبر البريد الإلكتروني <a href="mailto:sayedohod0@gmail.com" className="gold-text english-num">sayedohod0@gmail.com</a> أو واتساب لإعادة جدولة التوصيل.
          </p>
        </div>
      </div>
    </div>
